...
#define gly_test 0
#define gly_filter 0
#define gly_display 1
#define WINTER_FORCE_INTER 1
...
#if gly_display
typedef struct all_measure {
    float ts_correct;//ts正确率
    float encode_quality;//编码质量。1-5分
    float corect_quality;//码流质量。
    float clarity;//清晰度
} all_measure;
#endif
/**
